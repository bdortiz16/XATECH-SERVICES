...
Página web oficial de **XATECH Services** — tecnología inteligente para tu negocio.

Diseño inspirado en la estética de GitHub: tema oscuro, tarjetas tipo repositorio y tipografía del sistema.
...
La página es responsive (funciona en móvil y escritorio) y no requiere instalación ni build.
